      ...
      <div className="bg-white shadow-2xl rounded-3xl p-10 w-full max-w-2xl transform transition-all hover:scale-105 duration-300">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200 hover:shadow-lg transition-all">
            ...
            <p className="text-gray-700 font-medium tracking-wide">
              Server Message: <span className="text-blue-600">{serverData.message}</span>
            </p>
          </div>

          <div className="bg-purple-50 p-6 rounded-xl border-2 border-purple-200 hover:shadow-lg transition-all">
            <h2 className="text-xl font-bold text-purple-700 mb-4">Client Side</h2>
            <div className="flex items-center space-x-4">
              ...
              <span className="text-2xl font-bold text-purple-700">{clientCount}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 italic">
            Built with Bun, React, and Tailwind - Simplicity meets Performance! 🚀
          </p>
        </div>
      </div>
    </div>
